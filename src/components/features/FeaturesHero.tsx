  ...
  return (
    <section className="relative overflow-hidden min-h-[480px] flex items-center py-20 px-6">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 50% at 30% 50%, rgba(255,255,255,0.2) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="mx-auto max-w-6xl w-full flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="lg:w-1/2 text-white">
          <span className="inline-block rounded-full bg-white/15 px-4 py-1.5 text-xs font-medium backdrop-blur-sm border border-white/20">
            {featuresHero.badge}
          </span>
          <h1 className="mt-6 text-4xl font-bold leading-tight tracking-tight sm:text-5xl whitespace-pre-line">
